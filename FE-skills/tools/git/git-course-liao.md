...
Git 是目前世界上最先进的分布式版本控制系统。[官方网站](http://git-scm.com/)
...
---
* 方便参与到开源项目的修改中。
* 只有fork到自己账户下的项目clone，修改以后才能进行推送
...
* 配置文件
    * 配置 Git 的时候，加上--global 是针对当前用户起作用，如果不加，只针对当前仓库起作用
    * 配置文件放在.git/config 中
