...
ProfileManager.overseasModeProfile = {
    id:"overseas",
    name:"[" + I18n.getMessage("proxy_overseasMode") + "]",
    proxyMode:ProfileManager.ProxyModes.overseas,
    color:"haiwai"
};
...
ProfileManager.getProfile = function getProfile(profileId) {
   ...
   else if (profileId == ProfileManager.overseasModeProfile.id)
        profile = ProfileManager.overseasModeProfile;
...
ProfileManager.getCurrentProfile = function getCurrentProfile() {
	...
	if (proxyMode == ProfileManager.ProxyModes.overseas)
        return ProfileManager.overseasModeProfile;
